...
document.getElementById("btn").addEventListener("click",()=>{
    if(!started){
        ...
        document.getElementById("btn").style.backgroundColor="rgb(209, 90, 40)";
        if(flag){
            var day=document.getElementById("day").value;
            flag=false;
            virtualSec=120000/(122+(day-1)*2);
        ...
        document.getElementById("btn").textContent="Start";
        document.getElementById("btn").style.backgroundColor="rgb(26, 209, 139)";
        started=false;
